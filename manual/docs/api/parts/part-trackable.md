---
source: https://docs.inventree.org/en/stable/part/trackable/
component: parts
topic: Trackable Parts and Serial Numbers
fetched: 2026-04-13
---

> **Source**: [https://docs.inventree.org/en/stable/part/trackable/](https://docs.inventree.org/en/stable/part/trackable/)
...
Denoting a part as _Trackable_ changes the way that [stock items](../stock/index.md) associated with the particular part are handled in the database. A trackable part also has more restrictions imposed by the database scheme.
...
Any stock item associated with a trackable part _must_ have either a batch number or a serial number. This includes stock created manually or via an internal process (such as a [Purchase Order](../purchasing/purchase_order.md) or a [Build Order](../manufacturing/build.md)).
