...
Serializer for complete detail information of a part. Used in PATCH requests where all fields are optional.
...
| `barcode_hash`              | string                                             | read-only           | Unique hash of barcode data                                                                            |
...
| `full_name`                 | string                                             | read-only           | Format a 'full name' for this Part based on the format PART_NAME_FORMAT defined in InvenTree settings. |
...
| `name`                      | string                                             |                     | Part name; max length: 100                                                                             |
...
| `starred`                   | boolean                                            | read-only           | Return "true" if the part is starred by the current user.                                              |
...
| `default_location_detail`   | $ref: DefaultLocation                              | read-only, nullable |                                                                                                        |
| `parameters`                | array of $ref: Parameter                           | read-only, nullable |                                                                                                        |
| `category_path`             | array of $ref: TreePath                            | read-only, nullable |                                                                                                        |
| `tags`                      | array of string                                    |                     |                                                                                                        |
| `price_breaks`              | array of $ref: [PartSalePrice](part-sale-price.md) | read-only, nullable |                                                                                                        |
