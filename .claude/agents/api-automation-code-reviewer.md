...
1. **Hardcoded HTTP Status Codes**
   ...
   - ✅ Good: `.statusCode(HttpStatus.SC_OK)`, `.statusCode(HttpStatus.SC_CREATED)`, `.statusCode(HttpStatus.SC_NOT_FOUND)`
...
2. **Hardcoded Test Data Values**
   ...
   - ✅ Good: `Map.of("limit", CategoryTestData.DEFAULT_PAGE_LIMIT)`, `CategoryTestData.ERROR_MSG_NOT_FOUND`, `CategoryTestData.EMPTY_BODY`
   - Reference: `rest-assured-api-testing/core/no-hardcoding.md`
