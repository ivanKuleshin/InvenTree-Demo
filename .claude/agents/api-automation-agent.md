...
description: API Java Automation QA agent that generates structured automated test cases for the InvenTree domain. Should be used for API test implementation, debugging, fixing and investigation.
