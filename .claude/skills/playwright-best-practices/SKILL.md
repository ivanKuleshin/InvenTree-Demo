...
description:
  Use for all Playwright testing needs - E2E, component, API, visual, accessibility, security. Covers POM, fixtures, locators, CI/CD, mocking, auth, mobile, debugging flaky tests, test tags, performance budgets, and browser APIs.
license: MIT
metadata:
  author: currents.dev
  version: "1.1"
