...
component: api
topic: PaginatedPartSalePriceList
fetched: 2026-04-13
---

# PaginatedPartSalePriceList

Paginated list response wrapping an array of PartSalePrice objects.
...
| `results` | array of $ref: [PartSalePrice](part-sale-price.md) | required | |
