...
component: api
topic: PatchedPartPricing
fetched: 2026-04-13
---

# PatchedPartPricing

Serializer for Part pricing information. Used in PATCH requests where all fields are optional.
...
| `scheduled_for_update` | boolean | read-only | |
